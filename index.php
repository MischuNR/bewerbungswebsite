...
<body name="Top">
  <h1 id="titel">Michel Noël Rohrbach</h1>

  <div id="linkbox" class="linkbox">
    <a href="#" class="iconResponsive" id="iconResponsive" onclick="collabseMenu()">
      <i class="material-icons" style="font-size:6vh;">menu</i>
    </a>
    <a href="#Zeugnisse" class="links" onclick="collabseMenu()">Zeugnisse</a>
    <a href="#Projekte" class="links" onclick="collabseMenu()">Projekte</a>
    <a href="#Informatikkenntnisse" class="links" onclick="collabseMenu()">Informatikkenntnisse</a>
    <a href="#UeberMich" class="links" onclick="collabseMenu()">Über mich</a>
  </div>
  <h2 id="aktivitaet">Schüler Informatikmittelschule Bern</h2>
  <div class="responsiveSite">
    <button onclick="topFunction()" id="myBtn" title="Go to top"><i class="material-icons" style="font-size:30px;color:white">keyboard_arrow_up</i></button>
  ...
  <div class="responsiveContent2">
    ...
    <footer>
      ...
      <div class="impressum">
        ...
        <h id="impName">Michel Rohrbach</h2>
          <p class="impContent">Melchiorstrasse 9</p>
          <p class="impContent">3027 Bern</p>
          <p class="impContent">Schweiz</p>
          <p><a id="impMail" href="mailto:michel.n.rohrbach@gmail.com">michel.n.rohrbach@gmail.com</a></p>
          <hr id="copyright">
          <p class="impContent">&copy; Michel Rohrbach</p>
      </div>
    </footer>
